...
@section('title', "Daarul Rahmah - Edit Activity")
@section('content')
<section class="min-h-[90vh] w-full">
    ...
    <h2 class="font-semibold my-4 mb-4">Edit Kegiatan</h2>
    @include('components.alert')
    <div class="overflow-x-auto bg-base-100 p-4 rounded-xl shadow-xl">
        <form 
        action="{{ url('admin/activity/' . $data->id . '/update') }}" 
        method="POST"
        ...
        >
            ...
            <div class="col-span-2 form-control">
                ...
                <figure class="bg-base-300 rounded-lg">
                    <img id="image"
                    @if ($data->image !== null)
                    src={{ asset('imageActivity'.'/'.$data->image) }}
                    @else
            ...
            <div class="col-span-2 lg:col-span-1 form-control w-full">
                ...
                <input type="text" name="description" class="input input-lg input-bordered" value="{{ $data->description }}" />
            </div>
