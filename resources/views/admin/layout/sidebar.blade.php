<div class="drawer-side z-10">
  ...
  <ul class="menu w-80 min-h-full bg-base-100 text-base-content shadow-lg p-0 my-0 ml-0">
        ...
        <li class="w-full my-0">
            <a href={{ route('admin.dashboard') }} class="py-4 rounded-none {{ Route::is('admin.dashboard*') ? 'active' : '' }}">
        ...
        <li class="w-full my-0">
            ...
            <ul>
                <li class="my-0">
                    <a href="{{ route('admin.anggota') }}" class="py-4 rounded-none {{ Route::is('admin.anggota*') ? 'active' : '' }}">
        ...
        <li class="w-full my-0">
            <a href="{{ route('admin.news') }}" class="py-4 rounded-none {{ Route::is('admin.news*') ? 'active' : '' }}">
        ...
        <li class="w-full my-0">
            <a class="py-4 rounded-none {{ Route::is('admin.home*') ? 'active' : '' }} {{ Route::is('admin.about*') ? 'active' : '' }}" >
            ...
            <ul>
                <li class="my-0">
                    <a href="{{ route('admin.home.edit') }}" class="py-4 rounded-none {{ Route::is('admin.home*') ? 'active' : '' }}">
                ...
                <li class="my-0">
                    <a href="{{ route('admin.about.edit') }}" class="py-4 rounded-none {{ Route::is('admin.about*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-body-text" viewBox="0 0 16 16">
        ...
        <li class="w-full my-0">
            ...
            <ul>
                <li class="my-0">
                    <a href="{{ route('admin.donate') }}" class="py-4 rounded-none {{ Route::is('admin.donate*') ? 'active' : '' }}">
                ...
                <li class="my-0">
                    <a href="{{ route('admin.cash') }}" class="py-4 rounded-none {{ Route::is('admin.cash*') ? 'active' : '' }}">
