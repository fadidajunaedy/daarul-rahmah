@if (session('success'))
    <div role="alert" class="alert alert-success flex justify-between items-center mb-4 rounded-lg">
...
@if (session('warning'))
    <div role="alert" class="alert alert-warning flex justify-between items-center mb-4 rounded-lg">
...
@if ($errors->any())
<div role="alert" class="alert alert-error flex justify-between items-center mb-4 rounded-lg">
    <ul>
