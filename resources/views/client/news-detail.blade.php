...
<div class="container mx-auto px-4 mt-4 mb-6">
    <div class="breadcrumbs px-0 ">
        <ul class="mx-0 px-0 my-0">
          ...
          <li class="mx-0 px-0"><a href="{{ route('client.news') }}">Berita</a></li> 
          <li>{{ $data->title }}</li>
        </ul>
    </div>
    <div class="flex flex-col justify-center items-center jumbotron min-h-[50vh] rounded-lg shadow-xl px-4">
        <h1 class="text-center break-all">{{ $data->title }}</h1>
